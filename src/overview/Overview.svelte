<script>
  ...
  import {
    ...
    intermediateLayerPositionStore, selectedBitWidthStore, selectedShiftc11Store, selectedShiftc12Store, selectedShiftc21Store, selectedShiftc22Store
  } from '../stores.js';
  ...
  let bitWidthValues = overviewConfig.bitWidths;
  let minBitWidth = overviewConfig.bitWidths[0];
  let maxBitWidth = overviewConfig.bitWidths[-1];
  let bitWidthSlider;
  let selectedBitWidth = '2';
  selectedBitWidthStore.set(selectedBitWidth);
  let previousSelectedBitWidth = selectedBitWidth;

  $: selectedBitWidth, selectedBitWidthChanged();

  let selectedShiftc11 = '1';
  let selectedShiftc12 = '1';
  let selectedShiftc21 = '1';
  let selectedShiftc22 = '1';
  selectedShiftc11Store.set(selectedShiftc11);
  selectedShiftc12Store.set(selectedShiftc12);
  selectedShiftc21Store.set(selectedShiftc21);
  selectedShiftc22Store.set(selectedShiftc22);
  let previousselectedShiftc11 = selectedShiftc11;
  let previousselectedShiftc12 = selectedShiftc12;
  let previousselectedShiftc21 = selectedShiftc21;
  let previousselectedShiftc22 = selectedShiftc22;

  $: selectedShiftc11, selectedShiftc11Changed();
  $: selectedShiftc12, selectedShiftc12Changed();
  $: selectedShiftc21, selectedShiftc21Changed();
  $: selectedShiftc22, selectedShiftc22Changed();
  ...
  const layerLegendDict = {
    ...
    3: {local: 'local-legend-0-1', module: 'module-legend-0', global: 'global-legend'},
    ...
    6: {local: 'local-legend-0-2', module: 'module-legend-0', global: 'global-legend'},
    7: {local: 'local-legend-0-2', module: 'module-legend-0', global: 'global-legend'},
    8: {local: 'local-legend-1-1', module: 'module-legend-1', global: 'global-legend'},
    9: {local: 'local-legend-1-1', module: 'module-legend-1', global: 'global-legend'},
    10: {local: 'local-legend-1-1', module: 'module-legend-1', global: 'global-legend'},
    11: {local: 'local-legend-1-2', module: 'module-legend-1', global: 'global-legend'},
    12: {local: 'local-legend-1-2', module: 'module-legend-1', global: 'global-legend'},
    13: {local: 'local-legend-1-2', module: 'module-legend-1', global: 'global-legend'},
    14: {local: 'local-legend-1-2', module: 'module-legend-1', global: 'global-legend'},
    ...
    if (svg !== undefined) {
      ...
      if (selectedScaleLevel != previousSelectedScaleLevel){
        ...
        let updatingLayerIndexDict = {
          local: {
            module: [1, 2, 3, 11, 12, 13, 14],
            global: [1, 2, 3, 4, 5, 6, 7, 11, 12, 13, 14]
          },
          module: {
            local: [1, 2, 3, 11, 12, 13, 14],
            global: [1, 2, 3, 4, 5, 6, 7, 11, 12, 13, 14]
          },
          global: {
            local: [1, 2, 3, 4, 5, 6, 7, 11, 12, 13, 14],
  ...
  const nodeClickHandler = (d, i, g) => {
    ...
    if (d.type === 'conv' || d.type === 'bn' || d.type === 'relu' || d.type === 'pool') {
      let data = [];
    ...
    if (d.type == 'bn' || d.type == 'relu' || d.type == 'pool') {
  ...
  onMount(async () => {
    ...
    detailedViewAbsCoords = {
      ...
      3 : [600, 100 + svgYMid - 220 / 2, 490, 290],
      4 : [700, 100 + svgYMid - 220 / 2, 490, 290],
      5 : [650, 100 + svgYMid - 220 / 2, 490, 290],
      6 : [600, 100 + svgYMid - 220 / 2, 490, 290],
      7 : [650, 100 + svgYMid - 220 / 2, 490, 290],
      8 : [850, 100 + svgYMid - 220 / 2, 490, 290],
      9 : [475, 100 + svgYMid - 220 / 2, 490, 290],
      10 : [100, 100 + svgYMid - 220 / 2, 490, 290],
      11 : [60, 100 + svgYMid - 220 / 2, 490, 290],
      12 : [130, 100 + svgYMid - 220 / 2, 490, 290],
      13 : [200, 100 + svgYMid - 220 / 2, 490, 290],
      14 : [300, 100 + svgYMid - 220 / 2, 490, 290],
    }
    ...
    model = await loadTrainedModel(`PUBLIC_URL/assets/data/model_ours_${selectedBitWidth}.json`);
    cnn = await constructCNN(`PUBLIC_URL/assets/img/${selectedImage}`, model, [previousselectedShiftc11, previousselectedShiftc12, previousselectedShiftc21, previousselectedShiftc22]);
  ...
  const selectedBitWidthChanged = async () => {
    if (svg !== undefined) {
      console.log(selectedBitWidth, previousSelectedBitWidth)
      console.log(`PUBLIC_URL/assets/data/model_ours_${selectedBitWidth}.json`)
      if (selectedBitWidth !== previousSelectedBitWidth) {
        model = await loadTrainedModel(`PUBLIC_URL/assets/data/model_ours_${selectedBitWidth}.json`);
        cnn = await constructCNN(`PUBLIC_URL/assets/img/${selectedImage}`, model, [previousselectedShiftc11, previousselectedShiftc12, previousselectedShiftc21, previousselectedShiftc22]);
      ...
      previousSelectedBitWidth = selectedBitWidth;
      selectedBitWidthStore.set(selectedBitWidth);
    }
    selectedShiftc11 = '1';
    selectedShiftc12 = '1';
  ...
  const selectedShiftc11Changed = async () => {
    if (svg !== undefined) {
      console.log("Shift", selectedShiftc11, previousselectedShiftc11)
      if (selectedShiftc11 !== previousselectedShiftc11) {
        model = await loadTrainedModel(`PUBLIC_URL/assets/data/model_ours_${selectedBitWidth}.json`);
        cnn = await constructCNN(`PUBLIC_URL/assets/img/${selectedImage}`, model, [selectedShiftc11, previousselectedShiftc12, previousselectedShiftc21, previousselectedShiftc22]);
      ...
      previousselectedShiftc11 = selectedShiftc11;
      selectedShiftc11Store.set(selectedShiftc11);
    }
  }
  const selectedShiftc12Changed = async () => {
    if (svg !== undefined) {
      console.log("Shift", selectedShiftc12, previousselectedShiftc12)
      if (selectedShiftc12 !== previousselectedShiftc12) {
        model = await loadTrainedModel(`PUBLIC_URL/assets/data/model_ours_${selectedBitWidth}.json`);
        cnn = await constructCNN(`PUBLIC_URL/assets/img/${selectedImage}`, model, [previousselectedShiftc11, selectedShiftc12, previousselectedShiftc21, previousselectedShiftc22]);
      ...
      previousselectedShiftc12 = selectedShiftc12;
      selectedShiftc12Store.set(selectedShiftc12);
    }
  }
  const selectedShiftc21Changed = async () => {
    if (svg !== undefined) {
      console.log("Shift", selectedShiftc21, previousselectedShiftc21)
      if (selectedShiftc21 !== previousselectedShiftc21) {
        model = await loadTrainedModel(`PUBLIC_URL/assets/data/model_ours_${selectedBitWidth}.json`);
        cnn = await constructCNN(`PUBLIC_URL/assets/img/${selectedImage}`, model, [previousselectedShiftc11, previousselectedShiftc12, selectedShiftc21, previousselectedShiftc22]);
      ...
      previousselectedShiftc21 = selectedShiftc21;
      selectedShiftc21Store.set(selectedShiftc21);
    }
  }
  const selectedShiftc22Changed = async () => {
    if (svg !== undefined) {
      console.log("Shift", selectedShiftc22, previousselectedShiftc22)
      if (selectedShiftc22 !== previousselectedShiftc22) {
        model = await loadTrainedModel(`PUBLIC_URL/assets/data/model_ours_${selectedBitWidth}.json`);
        cnn = await constructCNN(`PUBLIC_URL/assets/img/${selectedImage}`, model, [previousselectedShiftc11, previousselectedShiftc12, previousselectedShiftc21, selectedShiftc22]);
      ...
      previousselectedShiftc22 = selectedShiftc22;
      selectedShiftc22Store.set(selectedShiftc22);
    }
  }
  ...
  const handleCustomImage = async (event) => {
    ...
    // Re-compute the CNN using the new input image
    cnn = await constructCNN(customImageURL, model, [previousselectedShiftc11, previousselectedShiftc12, previousselectedShiftc21, previousselectedShiftc22]);
...
<style>
  ...
  .control > .select > #bitwidth-select {
    padding-left: 2em;
    padding-right: 2em;
  }
...
<div class="overview"
  ...
  <div class="control-container">
    ...
    <div class="right-control">
      ...
      <div class="control is-very-small has-icons-left"
        ...
        <div class="select">
          <select bind:value={selectedBitWidth} id="bitwidth-select"
            disabled={disableControl}>
  ...
  <div class="control-container">
    ...
    <div class="left-control">
      ...
      <div class="control is-very-small has-icons-left"
        title="Change color scale range" style="margin-left: 5px; margin-right: 5px;">
        <p>batch normalization 1</p>
      </div>
      <div class="control is-very-small has-icons-left"
        title="Change color scale range">
        <span class="icon is-left">
        ...
        <div class="select">
          <select bind:value={selectedShiftc11} id="shift-select"
            disabled={disableControl}>
      ...
      <div class="control is-very-small has-icons-left"
        ...
        <div class="select">
          <select bind:value={selectedShiftc12} id="shift-select"
            disabled={disableControl}>
            <option value='0'>x0</option>
            <option value='0.01'>x0.01</option>
            <option value='0.1'>x0.1</option>
      ...
      <div class="control is-very-small has-icons-left"
        ...
        <div class="select">
          <select bind:value={selectedShiftc21} id="shift-select"
            disabled={disableControl}>
            <option value='0'>x0</option>
            <option value='0.01'>x0.01</option>
            <option value='0.1'>x0.1</option>
      ...
      <div class="control is-very-small has-icons-left"
        ...
        <div class="select">
          <select bind:value={selectedShiftc22} id="shift-select"
            disabled={disableControl}>
            <option value='0'>x0</option>
            <option value='0.01'>x0.01</option>
            <option value='0.1'>x0.1</option>
